...
RamDiskPublishSsdt()
{
    ...
    UINT8 nvdimmRootAml[0x7C] = {
        0x53, 0x53, 0x44, 0x54, sizeof(nvdimmRootAml), 0x00, 0x00, 0x00, 
        0x02, 0xc3, 0x53, 0x4f, 0x4c, 0x53, 0x20, 0x20, 
        0x52, 0x61, 0x6d, 0x44, 0x69, 0x73, 0x6b, 0x20, 
        0x00, 0x10, 0x00, 0x00, 0x49, 0x4e, 0x54, 0x4c, 
        0x29, 0x06, 0x18, 0x20, 0x10, 0x47, 0x05, 0x5c, 
...
RamDiskPublishNfit(IN RAMDISK_PRIVATE_DATA *PrivateData)
{
    ...
    UINT8 PcdAcpiDefaultOemId[6] = { 'S', 'O', 'L', 'S', ' ', ' ' };
